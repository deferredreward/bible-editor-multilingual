...
import { lookupOrgRecord, canonicalOrgName } from "./orgCanonical.ts";
import {
  listOrgRepos,
  fetchManifest,
  inferFromRepoList,
...
// lookupOrgRecord and canonicalOrgName now live in ./orgCanonical.ts (imported
// above) so the org-name write paths can share them without an import cycle.
