...
- Branch cut from `origin/main` *after* PR #43 (org-detect) and the user-management PR merged; api.ts interface conflict (AdminUser vs AquiferDraftsResponse) resolved by keeping both.
