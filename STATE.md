...
- **In progress:** Phase 2 (`WorkspaceLayout` extraction from Shell), Phase 3 (recursive renderer + resize lib + TopBar switcher, real components), Phase 4 (server defaults), Phase 5 (user-saved UX). Then local dev smoke before any merge. Classic MUST stay byte-identical.
