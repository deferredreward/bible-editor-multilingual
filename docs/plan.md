...
|---|---|---|
| `enhanced-word-aligner-rcl` works outside gatewayEdit's context providers | Alignment editor blocks; would have to inline gatewayEdit code | Spike: import the component into a minimal Vite app, feed it a sample verse JSON. **Do this before week 2.** |
