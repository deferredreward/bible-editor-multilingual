...
export type DeskSurface = {
  ...
  file: string;
  /** Literal string that must appear in `file` (component/section name) — proves the feature still lives there. */
  anchor: string;
};
...
export const ADMIN_SURFACES: AdminSurfaceEntry[] = [
  ...
  },
  {
    ...
    desk: { page: "team", file: "src/components/flows/AdminTeamScreen.tsx", anchor: "AdminTeamScreen" },
  ...
  },
  {
    ...
    classic: null,
    desk: { page: "progress", file: "src/components/flows/AdminProgressScreen.tsx", anchor: "AdminProgressScreen" },
  },
  {
    id: "workflow",
    label: "Workflow (steps / pipeline / sources / publishing)",
    classic: null,
    desk: { page: "workflow", file: "src/components/flows/AdminWorkflowScreen.tsx", anchor: "AdminWorkflowScreen" },
  },
  {
    id: "aiPipelines",
    label: "AI studio (run AI pipelines)",
    classic: null,
    desk: { page: "#/ai", file: "src/components/flows/AiScreen.tsx", anchor: "AiScreen" },
  ...
  },
  {
    ...
    classic: null,
    desk: { page: "#/style", file: "src/components/flows/StyleScreen.tsx", anchor: "StyleScreen" },
  ...
  },
  {
    ...
    classic: null,
    desk: { page: "#/curate", file: "src/components/flows/CurateScreen.tsx", anchor: "CurateScreen" },
  ...
  },
  {
    ...
    classic: null,
    desk: { page: "#/observe", file: "src/components/flows/ObserveScreen.tsx", anchor: "ObserveScreen" },
