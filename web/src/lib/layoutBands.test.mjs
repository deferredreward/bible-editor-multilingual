...
{
  assert(BAND_PX.tablet === 560 && BAND_PX.wide === 820 && BAND_PX.desktop === 900, "BAND_PX pins the three thresholds");
  assert(bandForWidth(0) === "phone", "0 -> phone");
  assert(bandForWidth(559) === "phone", "559 -> phone");
  assert(bandForWidth(560) === "tablet", "560 -> tablet");
  assert(bandForWidth(819) === "tablet", "819 -> tablet");
  assert(bandForWidth(820) === "tablet", "820 -> tablet (wide is a sub-band, not a band boundary)");
