...
import { onOutboxResult, outbox, type OutboxResult } from "../../sync/outbox";
import {
  api,
  ApiError,
...
// TnRow.note comes across with literal "\n" escape sequences (the source TSV
// format), not real newlines — same treatment ReviewQueue gives it.
...
function waitForOp(opId: string, timeoutMs = 20_000): Promise<OutboxResult | null> {
