// Org-wide admin UI-string override editor (backend: migration 0052,
// PUT /api/l10n/overrides/{lang}). Extracted out of PreferencesWorkspace.tsx
// (issue #189) so the adaptive-flows admin desk (AdminSetupScreen.tsx) can
// mount it directly — same move AiServiceSection.tsx already made for the AI
// provider section; this file mirrors that precedent (its own local
// useSaveState instead of importing PreferencesWorkspace's module-internal
// one).
