...
import { highlightsFor, overlayFindMarks, renderEditableHTML, renderHighlightedHTML, type HighlightKey, type ReorderHighlight } from "../lib/highlight";
    ...
    return (
      <Box
        ...
        sx={{
          ...
          fontSize: `calc(14.5px * var(--be-reading-scale, 1))`,
          lineHeight: 1.45,
